...
- **Spec coverage** (against ticket #92's brief):
  ...
  - Every render AA on its surfaces: measured pair table in constraints; components use only verified pairs (muted-text on white/glass/washes; brand-700 on light surfaces + gray-light; white + white/85 on deep; ink everywhere light). ✓
