...
| 2026-09-11 | #89 | (squash SHA at merge) | skip | — | this runbook + classifier + AGENTS.md pointer + plan/progress/graph — every path main-only; the AGENTS.md hunk is edition mechanics (content rule) — the next triager fills the SHA |
