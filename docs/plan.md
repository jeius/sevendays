...
- [ ] Booking flow componentized onto the #58 vocabulary — `ChoiceCard`, `HourChipGrid`, `StepProgress`, `ConfirmationCard` extracted; `SummaryRail` / `RejectionCard` restyled — zero flow changes (`data-*` seams preserved verbatim)
