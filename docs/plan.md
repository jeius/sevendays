...
- [ ] Login UI + shell gate: `/login` on the design system (UI-bearing ticket — skill set named, owner-reacted variants per the #94 amendment); `_shell` `beforeLoad` session gate with redirect preservation; sign-out in the shell user card
