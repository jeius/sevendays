...
// full description. The editor chrome is the ruled Sheet everywhere (V1
// settled); the applies-to matrix renders as selectable name-only toggle
// cards writing straight into the row's local studioServiceIds. Nothing
